			...
			<div id="search">
				...
				<form id="search-form" action="">
					<input type="text" id="search-query"
					 placeholder="keyword" autoCorrect="off" autoCapitalize="off" spellCheck="false" />
	...
	render: function() {
		...
		var playPause = (function() {
			if(this.props.isPlaying)
				return (
					<div id="pause" className={this.props.currentTrack.index === -1 ? "disabled" : ""} 
						onClick={this.props.pause}><span></span></div>
				);
			else
				return (
					<div id="play" className={this.props.currentTrack.index === -1 ? "disabled" : ""} 
						onClick={this.props.play}><span></span></div>
				);
		}.bind(this))();

		return (
			<div id="controls">
				<div id="skip-prev" className={this.props.currentTrack.index === -1 ? "disabled" : ""} 
					onClick={this.props.skipPrev}><span></span>
				</div>
				{playPause}
				<div id="skip-next" className={this.props.nextTrack === -1 ? "disabled" : ""} 
					onClick={this.props.skipNext}><span></span>
				</div>
				<div id="replay" className={!this.props.replay ? "disabled" : ""} 
					onClick={this.props.toggleReplay}><span></span><span></span><span></span><span></span><span>1</span>
				</div>
			</div>
		);
	}
		...
		return (
			<div id="header">
				<div id="header-center">
					...
					<Deck currentTrack={this.props.currentTrack} prevTrack={this.props.prevTrack} 
						nextTrack={this.props.nextTrack} setTrack={this.props.setTrack} />
				</div>
			</div>
		);
	}
...
ReactDOM.render(
	<Kleng />,
	document.getElementById("kleng-container")
);