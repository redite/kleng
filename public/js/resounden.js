	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement("input", { type: "text", id: "search-query",
	...
	render: function () {
		...
		var playPause = function () {
			if (this.props.isPlaying) return React.createElement(
				"div",
				{ id: "pause", className: this.props.currentTrack.index === -1 ? "disabled" : "",
					onClick: this.props.pause },
				React.createElement("span", null)
			);else return React.createElement(
				"div",
				{ id: "play", className: this.props.currentTrack.index === -1 ? "disabled" : "",
		...
		return React.createElement(
			...
			React.createElement(
				"div",
				{ id: "skip-prev", className: this.props.currentTrack.index === -1 ? "disabled" : "",
					onClick: this.props.skipPrev },
				React.createElement("span", null)
			),
			playPause,
			React.createElement(
				"div",
				{ id: "skip-next", className: this.props.nextTrack === -1 ? "disabled" : "",
					onClick: this.props.skipNext },
				React.createElement("span", null)
			),
			React.createElement(
				"div",
				{ id: "replay", className: !this.props.replay ? "disabled" : "",
					onClick: this.props.toggleReplay },
				React.createElement("span", null),
				React.createElement("span", null),
				React.createElement("span", null),
				React.createElement("span", null),
...
ReactDOM.render(React.createElement(Kleng, null), document.getElementById("kleng-container"));
